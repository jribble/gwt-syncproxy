 ...
 * 
 * This is an exact copy of the GWT version, but the policies are switched for serialization and deserialization.
 */
public final class SerializationPolicyLoader {
  ...
  public static SerializationPolicy loadFromStream(InputStream inputStream,
    ...
    /****************************************
     * HERE'S THE CHANGE FROM THE ORIGINAL
     * Deser and Ser are swapped because we are the client side
     */
    return new StandardSerializationPolicy(whitelistDeser, whitelistSer,
